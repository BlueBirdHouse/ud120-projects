...
'''
#from questionFuns import dataList
#Temp = dataList(data_dict,'salary')
...
'''
    ...
    on the “salary” and “exercised_stock_options” features (use only these two 
    features). What would be the rescaled value of a "salary" feature that had 
    an original value of $200,000, and an "exercised_stock_options" feature of 
    $1 million? (Be sure to represent these numbers as floats, not integers!)
'''
#Temp = np.array([200000.,1000000.])
